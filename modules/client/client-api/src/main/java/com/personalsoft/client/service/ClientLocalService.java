...
public interface ClientLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.personalsoft.client.service.impl.ClientLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the client local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ClientLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Client> getClientsBydocumentTypeAndNumber(
